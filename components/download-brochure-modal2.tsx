...
export function DownloadBrochureModal2({ children, pdfUrl = "/Treppan-Tower-Brochure.pdf", headingText = "Download Brochure" }: { children?: React.ReactNode, pdfUrl?: string, headingText?: string }) {
